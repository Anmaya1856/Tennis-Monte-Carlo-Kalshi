...
_SNAPSHOT_COLS = [
    "timestamp", "ticker", "p2_ticker", "milestone_id", "p1_name", "p2_name", "best_of", "score_str", "game_score_str", "server",
    "mc_prob_p1", "mc_set_prob_p1", "mc_game_prob_p1",
    "mc_vol_point", "mc_vol_game",
    "cond_win_point", "cond_lose_point", "cond_win_game", "cond_lose_game", "cond_win_set", "cond_lose_set",
...
def log_snapshot(ticker, p1_name, p2_name, score_str, game_score_str, server,
                 ...
                 ms, pos_side, pos_value, p2_ticker=None, p1_kstats=None, p2_kstats=None,
    ...
    _append("match_snapshots.csv", _SNAPSHOT_COLS, {
        ...
        **rep,
        ...
        "cond_win_point":             "" if cond is None else round(cond["win_point"], 4),
        "cond_lose_point":            "" if cond is None else round(cond["lose_point"], 4),
        ...
        "position_unrealized_pnl":    round(pos["count"] * (pos_value - pos["entry_price"]), 4) if (pos and pos_value is not None) else "",
